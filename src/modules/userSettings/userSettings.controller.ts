...
export const getUserSettingsByIdController = async (
  req: express.Request,
  res: express.Response
) => {
  try {
...
export const createUserSettingsController = async (
  req: express.Request,
  res: express.Response
) => {
  try {
...
export const updateUserSettingsController = async (
  ...
  try {
    const updatedSetting = await updateUserSettingsById(
      req.params.id,
      req.body
    );
    if (!updatedSetting) {
...
export const deleteUserSettingsController = async (
  req: express.Request,
  res: express.Response
) => {
  try {
